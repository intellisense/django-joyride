...
def get_joyride_context():
    context = {
        'JOYRIDE_CSS_URL': absolute_url('joyride/css/joyride-2.1.min.css'),
        }
    ...
    return context
register.joyride_context = get_joyride_context()
...
def joyride_css():
    return register.joyride_context
